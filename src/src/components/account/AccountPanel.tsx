  ...
  if (loading && !session) {
    return (
      <div className="max-w-2xl rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <p className="font-black text-slate-900">Loading Mucipes account…</p>
      </div>
    );
  }
      ...
      <div className="max-w-2xl space-y-4">
        <section className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
          <div className="border-b border-emerald-100 bg-emerald-50 p-6 text-slate-950">
            <p className="text-xs font-black uppercase tracking-[0.18em] text-emerald-400">Mucipes Cloud</p>
      ...
      <section className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-emerald-100 bg-emerald-50 p-6 text-slate-950">
          ...
          <p className="mt-2 text-sm text-slate-500">
            {mode === "login" ? "Sign in to your Mucipes account." : "One account for your future training, nutrition and progress sync."}
          </p>
        </div>
        ...
        <div className="p-6">
          ...
          <p className="mt-5 text-xs leading-5 text-slate-400">
            Mucipes never needs your Supabase secret/service-role key in the browser. The app uses only the public publishable key from your environment file.
          </p>
        </div>
      </section>
    </div>
